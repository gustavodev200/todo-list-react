...
const Task = () => {
  ...
  return (
    <div className="max-h-[60%] overflow-y-scroll py-2 pb-10 no-scrollbar">
                  ...
                  <Draggable draggableId={task.id} index={index}>
                    {(provided) => (
                      <li
                        ...
                        className="w-full flex items-center justify-between text-xl py-2 px-4 rounded-md bg-slate-800 text-slate-200"
                      >
                        <span className="flex">
